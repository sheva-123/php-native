...
mysqli_query($koneksi, "DELETE FROM minuman WHERE Stok = 0");
...
<body>
  ...
  <section id="dataproduk">
    <fieldset class="iptprd">
      ...
      <form method="post" action="inputminuman.php">
        <table border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td>Nama Produk</td>
            <td><input type="text" name="minuman" require/></td>
          </tr>
          <tr>
            <td>Harga</td>
            <td><input type="text" name="harga" require/></td>
          </tr>
          <tr>
            <td>Stok</td>
            <td><input type="text" name="stok" require/></td>
          </tr>
          <tr>
            <td>Foto Produk</td>
            <td><input type="file" name="foto" accept=".jpg, .png" require/></td>
          </tr>
          <tr>
    ...
    <fieldset class="dtprdk">
      ...
      <table border="1" cellspacing="0" cellpadding="10">
        ...
        <?php
        $no = 1;
        $ambil = mysqli_query($koneksi, "SELECT * FROM minuman ");
        ...
        ?>
          <tr class="trprdk">
            ...
            <td>
              <div align="center">
                <a href="editminuman2.php?idnya=<?php echo $array['MinumanId']; ?>">EDIT</a>
              </div>
            </td>
            <td>
              <div align="center">
                <a href="deleteminuman.php?idnya=<?php echo $array['MinumanId']; ?>" onclick="return confirm('Yakin akan dihapus?')">HAPUS</a>
              </div>
            </td>
          </tr>
        <?php
